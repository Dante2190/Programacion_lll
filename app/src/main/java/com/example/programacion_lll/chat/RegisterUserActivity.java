...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tomarFoto();
        try {
            mDatabse = FirebaseDatabase.getInstance().getReference("usuariosChat");
        ...
        Button ya = (Button)findViewById(R.id.btnGuardarRegistros);
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        try {
                            Uri photoURI = FileProvider.getUriForFile(RegisterUserActivity.this, "com.example.programacion_lll.fileprovider", photoFile);
